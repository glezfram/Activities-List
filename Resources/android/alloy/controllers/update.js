function Controller() {
    ...
    $.__views.updateWin.add($.__views.__alloyId25);
    updateItem ? $.__views.__alloyId25.addEventListener("click", updateItem) : __defers["$.__views.__alloyId25!click!updateItem"] = true;
    ...
    $.__views.updateWin.add($.__views.__alloyId26);
    closeWindow ? $.__views.__alloyId26.addEventListener("click", closeWindow) : __defers["$.__views.__alloyId26!click!closeWindow"] = true;
    ...
    __defers["$.__views.__alloyId25!click!updateItem"] && $.__views.__alloyId25.addEventListener("click", updateItem);
    __defers["$.__views.__alloyId26!click!closeWindow"] && $.__views.__alloyId26.addEventListener("click", closeWindow);
    _.extend($, exports);
}
